...
class ExtendedMetaDataMatchQuery(FieldQuery):
    ...
    def value_match(cls, pattern, val):
        ...
        if len(field_patterns) is 0 and len(negated_field_patterns) is 1 and len(negated_field_patterns[0]) is 0:
            return False
